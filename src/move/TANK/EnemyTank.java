        ...
        for(int i=0;i<enemyTanks.size();i++)
        {
            ...
            if(tank2!=this) {
                if (getDirection() == 0 || getDirection() == 2)
                    //上下
                {
                    if (tank2.getDirection() == 0 || tank2.getDirection() == 2)
                        //上下
                    {
                        //左上
                    ...
                    //左右
                {
                        ...
                        //上下
                    {
                        if (tank2.getX() >=getX() && tank2.getX() <getX() + 60
                                && tank2.getY() >=getY() && tank2.getY() <= getY() + 40)
                            //左上
                        {frag1 = true;}
                        else if (tank2.getX() + 40 >= getX() && tank2.getX() + 40 < getX() + 40
                                && tank2.getY() >= getY() && tank2.getY() <= getY() + 40)
                        ...
                        {frag1 = true;}
                                ...
                                && tank2.getY() + 60 >= getY() && tank2.getY() + 60 <=getY() + 40)
                            //左下
                        {frag1 = true;}
                    ...
                    if (tank2.getDirection() == 1 || tank2.getDirection() == 3)
                        //左右
                    {
                        if (tank2.getX() >= getX() && tank2.getX() < getX() + 60
                                && tank2.getY() >= getY() && tank2.getY() <= getY() + 40)
                            ...
                            //右上
                        {
                            frag1 = true;
                                ...
                                && tank2.getY() + 40 >= getY() && tank2.getY() + 40 <= getY() + 40)
                            //左下
                        {
                            frag1 = true;
